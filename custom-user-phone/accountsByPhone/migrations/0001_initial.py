# Generated by Django 3.2.9 on 2021-12-21 04:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.IntegerField(unique=True, verbose_name='Telefon Raqam')),
                ('address', models.CharField(max_length=100, verbose_name='Manzil')),
                ('age', models.IntegerField(verbose_name='Yosh')),
                ('joined_date', models.DateTimeField(auto_now_add=True, verbose_name="Ro'yhatga olingan vaqt")),
